...
public class Main {
    ...
    public static void main(String[] args) {
     ...
     static void addOrder() {
        ...
        db.addOrder(clientId, productId, price);
    }
     static void addContract() {
        ...
        db.addContract(clientId, startDate, endDate);
    }

    private static void addSupportIssue() {
        System.out.print("Введите ID клиента: ");
        int clientId = scanner.nextInt();
        scanner.nextLine(); // Потребляем символ новой строки
        ...
        db.addSupportIssue(clientId, description, status);
    }
